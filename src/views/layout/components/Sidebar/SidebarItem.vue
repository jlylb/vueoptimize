<template>
  <div v-if="!item.hidden&&item.children" class="menu-wrapper">
    <router-link
      v-if="item.children.length===1 && item.children[0].hidden && !item.always_show"
    ...
    <router-link
      v-else-if="hasOneShowingChildren(item.children) && !item.children[0].children&&!item.always_show"
